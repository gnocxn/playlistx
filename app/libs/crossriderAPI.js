...
if (window.jQuery && window.jQuery.fn) {
	window.jQuery.fn.fireExtensionEvent = function(evt, data) {
		return this.each(function() {
			CrossriderAPI.fireExtensionEvent(this, evt, data);
		});
	};

	window.jQuery.fn.bindExtensionEvent = function(evt, callback) {
		return this.each(function() {
			var _callback = function (e, data) {
				callback(jQuery.event.fix(e), data);
			}
	...
	CrossriderAPI.ready = jQuery(document).ready;
}
else {
